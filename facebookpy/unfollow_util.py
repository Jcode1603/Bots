...
def get_following_status(browser, track, username, person, person_id, logger,
    ...
    if track == "profile":
        ...
        web_address_navigator( browser, ig_homepage + person, logger)
    ...
    valid_page = is_page_available(browser, logger, logger)
    if not valid_page:
...
def follow_user(browser, track, login, userid_to_follow, button, blacklist,
    ...
    if track in ["profile", "post"]:
        if track == "profile":
            ...
            user_link = "https://web.facebook.com/{}/".format(userid_to_follow)
...
def get_given_user_followers(browser,
    ...
    user_link = "https://web.facebook.com/{}".format(userid)
    web_address_navigator( browser, user_link, logger)
    ...
    allfollowers, allfollowing = get_relationship_counts(browser, "https://web.facebook.com/", user_name,
                                                         userid, logger, Settings)
    ...
    user_followers_link = "https://web.facebook.com/{}/followers".format(
        userid)
    web_address_navigator( browser, user_followers_link, logger)
